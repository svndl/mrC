...
% distance-dependence of coherence (according to MAE1 numbers Fig. 4 from 'Multi-scale
...
if true
    ...
    filename = fullfile(plot_dir,'spatial_decay_coherence_expo_only');
    print(filename,'-dpdf');
    filename = fullfile(plot_dir,'spatial_decay_coherence_all_fitFuncs_smallRange');
    figure(fig_all_fits)
    print(filename,'-dpdf');
    end