...
load('/Users/babylab/Documents/Elham/simulation/coordsForSB') % What is the unit of positions? Decay of spatial coherence assumes mm...
coords=coords.all;

scatter3(coords(:,1),coords(:,2),coords(:,3));%ADDED BY ELHAM
...
hold on, scatter3(coords(:,1),coords(:,2),coords(:,3),'fill','r')% ADDED BY ELHAM
