function [mapMtx totalTrans] = DefaultCortexMorphMap(fromSub,toSub)
%function [mapMtx] = mrC.DefaultCortexMorphMap(fromSub,toSub)
%
...
%
% example usage:
% [mapMtx] = mrC.DefaultCortexMorphMap('skeri0001','skeri0055');

% $Log: makeDefaultCortexMorphMap.m,v $
% Revision 1.5 2016/2016/25 kohler
% changed function name from makeDefaultCortexMorphMap.m
% to mrC.DefaultCortexMorphMap so it can be included in mrC package
%
